...
class ControlIncidenciasController extends Controller
{
    ...
    {
        $incidencias = Incidencias::find()->where(['estado' => 'pendiente'])->all();//model
        return $this->render('//controlincidencia/index', ['incidencias' => $incidencias]);//view
    }
    ...
    {
        $incidencia = Incidencias::findOne($id);
