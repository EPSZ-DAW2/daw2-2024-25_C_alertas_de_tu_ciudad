...
CREATE TABLE IF NOT EXISTS `imagen` (
    ...
    `ruta_archivo` VARCHAR(512) NOT NULL COMMENT 'Ruta relativa del archivo subido',
    `tam_img` INT(11) DEFAULT NULL COMMENT 'Tamaño del archivo en bytes',
...
INSERT INTO `imagen` (`nombre`, `usuario_id`, `alerta_id`, `ruta_archivo`, `tam_img`, `metadatos`, `created_at`) VALUES
    ('tormenta_europa', 1, 1, '2023/11/1/admin/tormenta_europa.jpg', 204800, '{"evento":"Tormenta severa","ubicacion":"Europa","descripcion":"Fuertes vientos y lluvias"}', CURRENT_TIMESTAMP),
    ('inundaciones_espana', 1, 2, '2023/11/1/admin/inundaciones_espana.jpg', 256000, '{"evento":"Inundaciones","ubicacion":"España","descripcion":"Lluvias intensas"}', CURRENT_TIMESTAMP),
    ('incendio_andalucia', 1, 3, '2023/11/1/admin/incendio_andalucia.jpg', 512000, '{"evento":"Incendio forestal","ubicacion":"Andalucía"}', CURRENT_TIMESTAMP),
    ('nevadas_aragon', 1, 4, '2023/11/1/admin/nevadas_aragon.jpg', 409600, '{"evento":"Nevadas","ubicacion":"Aragón","impacto":"Carreteras bloqueadas"}', CURRENT_TIMESTAMP),
    ('accidente_asturias', 1, 5, '2023/11/1/admin/accidente_asturias.jpg', 150000, '{"evento":"Accidente","ubicacion":"Asturias","carretera":"A-8"}', CURRENT_TIMESTAMP),
    ('temporal_baleares', 1, 6, '2023/11/1/admin/temporal_baleares.jpg', 300000, '{"evento":"Temporal","ubicacion":"Islas Baleares"}', CURRENT_TIMESTAMP),
    ('volcan_canarias', 1, 7, '2023/11/1/admin/volcan_canarias.jpg', 350000, '{"evento":"Actividad volcánica","ubicacion":"Canarias"}', CURRENT_TIMESTAMP),
    ('derrumbe_cantabria', 1, 8, '2023/11/1/admin/derrumbe_cantabria.jpg', 180000, '{"evento":"Derrumbe","ubicacion":"Cantabria","tipo":"Carreteras"}', CURRENT_TIMESTAMP),
    ('ola_calor_extremadura', 1, 9, '2023/11/1/admin/ola_calor_extremadura.jpg', 220000, '{"evento":"Ola de calor","ubicacion":"Extremadura"}', CURRENT_TIMESTAMP),
    ('temporal_galicia', 1, 10, '2023/11/1/admin/temporal_galicia.jpg', 240000, '{"evento":"Temporal","ubicacion":"Galicia"}', CURRENT_TIMESTAMP),
    ('manifestacion_madrid', 1, 11, '2023/11/1/admin/manifestacion_madrid.jpg', 300000, '{"evento":"Manifestación","ubicacion":"Madrid"}', CURRENT_TIMESTAMP),
    ('terremoto_murcia', 1, 12, '2023/11/1/admin/terremoto_murcia.jpg', 280000, '{"evento":"Terremoto","magnitud":5.2,"ubicacion":"Murcia"}', CURRENT_TIMESTAMP),
    ('granizada_navarra', 1, 13, '2023/11/1/admin/granizada_navarra.jpg', 350000, '{"evento":"Granizada","ubicacion":"Navarra"}', CURRENT_TIMESTAMP),
    ('tornado_la_rioja', 1, 14, '2023/11/1/admin/tornado_la_rioja.jpg', 500000, '{"evento":"Tornado","ubicacion":"La Rioja"}', CURRENT_TIMESTAMP),
    ('explosion_pais_vasco', 1, 15, '2023/11/1/admin/explosion_pais_vasco.jpg', 450000, '{"evento":"Explosión","ubicacion":"País Vasco","tipo":"Zona industrial"}', CURRENT_TIMESTAMP),
    ('robo_valencia', 1, 16, '2023/11/1/admin/robo_valencia.jpg', 100000, '{"evento":"Robo","ubicacion":"Comunidad Valenciana"}', CURRENT_TIMESTAMP),
    ('emergencia_sanitaria_ceuta', 1, 17, '2023/11/1/admin/emergencia_sanitaria_ceuta.jpg', 120000, '{"evento":"Brote infeccioso","ubicacion":"Ceuta"}', CURRENT_TIMESTAMP),
    ('cierre_puerto_melilla', 1, 18, '2023/11/1/admin/cierre_puerto_melilla.jpg', 150000, '{"evento":"Cierre puerto","ubicacion":"Melilla","causa":"Oleaje"}', CURRENT_TIMESTAMP),
    ('incendio_salamanca', 1, 19, '2023/11/1/admin/incendio_salamanca.jpg', 190000, '{"evento":"Incendio","ubicacion":"Salamanca","tipo":"Zona industrial"}', CURRENT_TIMESTAMP),
    ('corte_agua_salamanca', 1, 20, '2023/11/1/admin/corte_agua_salamanca.jpg', 130000, '{"evento":"Corte de agua","ubicacion":"Salamanca","motivo":"Mantenimiento"}', CURRENT_TIMESTAMP),
    ('transporte_salamanca', 1, 21, '2023/11/1/admin/transporte_salamanca.jpg', 170000, '{"evento":"Fallo transporte","ubicacion":"Salamanca"}', CURRENT_TIMESTAMP),
    ('concierto_salamanca', 1, 22, '2023/11/1/admin/concierto_salamanca.jpg', 250000, '{"evento":"Concierto","ubicacion":"Plaza Mayor, Salamanca"}', CURRENT_TIMESTAMP),
    ('feria_libro_salamanca', 1, 23, '2023/11/1/admin/feria_libro_salamanca.jpg', 220000, '{"evento":"Feria del libro","ubicacion":"Salamanca"}', CURRENT_TIMESTAMP),
    ('contaminacion_aire', 1, 24, '2023/11/1/admin/contaminacion_aire.jpg', 190000, '{"evento":"Contaminación","ubicacion":"Salamanca"}', CURRENT_TIMESTAMP),
    ('manifestacion_plaza_mayor', 1, 25, '2023/11/1/admin/manifestacion_plaza_mayor.jpg', 210000, '{"evento":"Manifestación","ubicacion":"Plaza Mayor, Salamanca"}', CURRENT_TIMESTAMP),
    ('fuga_gas_garrido', 1, 26, '2023/11/1/admin/fuga_gas_garrido.jpg', 170000, '{"evento":"Fuga de gas","ubicacion":"Barrio de Garrido, Salamanca"}', CURRENT_TIMESTAMP),
    ('accidente_cementerio', 1, 27, '2023/11/1/admin/accidente_cementerio.jpg', 150000, '{"evento":"Accidente","ubicacion":"Avenida Cementerio, Salamanca"}', CURRENT_TIMESTAMP),
    ('robo_pizarrales', 1, 28, '2023/11/1/admin/robo_pizarrales.jpg', 130000, '{"evento":"Robo","ubicacion":"Barrio de Pizarrales, Salamanca"}', CURRENT_TIMESTAMP),
    ('corte_electrico_san_jose', 1, 29, '2023/11/1/admin/corte_electrico_san_jose.jpg', 120000, '{"evento":"Corte eléctrico","ubicacion":"Barrio de San José, Salamanca"}', CURRENT_TIMESTAMP),
    ('mercado_medieval', 1, 30, '2023/11/1/admin/mercado_medieval.jpg', 250000, '{"evento":"Mercado medieval","ubicacion":"Plaza Mayor, Salamanca"}', CURRENT_TIMESTAMP),
    ('corte_agua_garrido', 1, 31, '2023/11/1/admin/corte_agua_garrido.jpg', 180000, '{"evento":"Corte de agua","ubicacion":"Barrio de Garrido, Salamanca"}', CURRENT_TIMESTAMP),
    ('actividad_comunitaria', 1, 32, '2023/11/1/admin/actividad_comunitaria.jpg', 160000, '{"evento":"Limpieza comunitaria","ubicacion":"Barrio de Garrido, Salamanca"}', CURRENT_TIMESTAMP);
