...
INSERT INTO `ubicacion` (`id`, `ub_code`, `nombre`, `code_iso`, `ub_code_padre`, `latitud`, `longitud`, `fecha_creacion`, `is_revisada`) VALUES
    (0, 0, 'Tierra', NULL, NULL, NULL, NULL, NOW(), TRUE),
    (1, 1, 'África', 'AF', 0, -8.7832, 34.5085, NOW(), TRUE),
    (2, 1, 'América', 'AM', 0, 8.7832, -55.4915, NOW(), TRUE),
    (3, 1, 'Asia', 'AS', 0, 34.0479, 100.6197, NOW(), TRUE),
    (4, 1, 'Europa', 'EU', 0, 54.5260, 15.2551, NOW(), TRUE),
    (5, 1, 'Oceanía', 'OC', 0, -22.7359, 140.0188, NOW(), TRUE),
    -- África
    (6, 2, 'Nigeria', 'NG', 1, 9.0820, 8.6753, NOW(), TRUE),
    (7, 2, 'Sudáfrica', 'ZA', 1, -30.5595, 22.9375, NOW(), TRUE),
    (8, 2, 'Egipto', 'EG', 1, 26.8206, 30.8025, NOW(), TRUE),
    (9, 2, 'Kenia', 'KE', 1, -1.286389, 36.817223, NOW(), TRUE),
    (10, 2, 'Ghana', 'GH', 1, 7.9465, -1.0232, NOW(), TRUE),
    (11, 2, 'Argelia', 'DZ', 1, 28.0339, 1.6596, NOW(), TRUE),
    (12, 2, 'Marruecos', 'MA', 1, 31.7917, -7.0926, NOW(), TRUE),
    (13, 2, 'Etiopía', 'ET', 1, 9.1450, 40.4897, NOW(), TRUE),
    (14, 2, 'Angola', 'AO', 1, -11.2027, 17.8739, NOW(), TRUE),
    (15, 2, 'Tanzania', 'TZ', 1, -6.3690, 34.8888, NOW(), TRUE),
    -- América
    (16, 2, 'Estados Unidos', 'US', 2, 37.0902, -95.7129, NOW(), TRUE),
    (17, 2, 'Brasil', 'BR', 2, -14.2350, -51.9253, NOW(), TRUE),
    (18, 2, 'Canadá', 'CA', 2, 56.1304, -106.3468, NOW(), TRUE),
    (19, 2, 'Argentina', 'AR', 2, -38.4161, -63.6167, NOW(), TRUE),
    (20, 2, 'México', 'MX', 2, 23.6345, -102.5528, NOW(), TRUE),
    (21, 2, 'Colombia', 'CO', 2, 4.5709, -74.2973, NOW(), TRUE),
    (22, 2, 'Chile', 'CL', 2, -35.6751, -71.5430, NOW(), TRUE),
    (23, 2, 'Perú', 'PE', 2, -9.1900, -75.0152, NOW(), TRUE),
    (24, 2, 'Venezuela', 'VE', 2, 6.4238, -66.5897, NOW(), TRUE),
    (25, 2, 'Cuba', 'CU', 2, 21.5218, -77.7812, NOW(), TRUE),
    -- Asia
    (26, 2, 'China', 'CN', 3, 35.8617, 104.1954, NOW(), TRUE),
    (27, 2, 'India', 'IN', 3, 20.5937, 78.9629, NOW(), TRUE),
    (28, 2, 'Japón', 'JP', 3, 36.2048, 138.2529, NOW(), TRUE),
    (29, 2, 'Rusia', 'RU', 3, 61.5240, 105.3188, NOW(), TRUE),
    (30, 2, 'Corea del Sur', 'KR', 3, 35.9078, 127.7669, NOW(), TRUE),
    (31, 2, 'Indonesia', 'ID', 3, -0.7893, 113.9213, NOW(), TRUE),
    (32, 2, 'Arabia Saudita', 'SA', 3, 23.8859, 45.0792, NOW(), TRUE),
    (33, 2, 'Pakistán', 'PK', 3, 30.3753, 69.3451, NOW(), TRUE),
    (34, 2, 'Bangladés', 'BD', 3, 23.6850, 90.3563, NOW(), TRUE),
    (35, 2, 'Irán', 'IR', 3, 32.4279, 53.6880, NOW(), TRUE),
    -- Europa
    (36, 2, 'Francia', 'FR', 4, 46.6034, 1.8883, NOW(), TRUE),
    (37, 2, 'Alemania', 'DE', 4, 51.1657, 10.4515, NOW(), TRUE),
    (38, 2, 'Italia', 'IT', 4, 41.8719, 12.5674, NOW(), TRUE),
    (39, 2, 'Reino Unido', 'GB', 4, 55.3781, -3.4360, NOW(), TRUE),
    (40, 2, 'Países Bajos', 'NL', 4, 52.1326, 5.2913, NOW(), TRUE),
    (41, 2, 'Bélgica', 'BE', 4, 50.8503, 4.3517, NOW(), TRUE),
    (42, 2, 'Portugal', 'PT', 4, 39.3999, -8.2245, NOW(), TRUE),
    (43, 2, 'Suecia', 'SE', 4, 60.1282, 18.6435, NOW(), TRUE),
    (44, 2, 'Noruega', 'NO', 4, 60.4720, 8.4689, NOW(), TRUE),
    (45, 2, 'España', 'ES', 4, 40.4637, -3.7492, NOW(), TRUE),
    -- Comunidades Autónomas de España
    (46, 3, 'Andalucía', 'AN', 45, 37.3828, -5.9700, NOW(), TRUE),
    (47, 3, 'Cataluña', 'CT', 45, 41.5912, 1.5209, NOW(), TRUE),
    (48, 3, 'Madrid', 'MD', 45, 40.4168, -3.7038, NOW(), TRUE),
    (49, 3, 'Castilla y León', 'CY', 45, 41.5948, -4.0247, NOW(), TRUE),
    (50, 3, 'Castilla-La Mancha', 'CL', 45, 39.9440, -3.1190, NOW(), TRUE),
    (51, 3, 'Comunidad Valenciana', 'VC', 45, 39.4699, -0.3763, NOW(), TRUE),
    (52, 3, 'Galicia', 'GA', 45, 42.8935, -8.3828, NOW(), TRUE),
    (53, 3, 'País Vasco', 'PV', 45, 43.0634, -2.7123, NOW(), TRUE),
    (54, 3, 'Aragón', 'AR', 45, 41.6460, -0.8891, NOW(), TRUE),
    (55, 3, 'Canarias', 'CN', 45, 28.2916, -15.4237, NOW(), TRUE),
    (56, 3, 'Extremadura', 'EX', 45, 39.1610, -6.0264, NOW(), TRUE),
    (57, 3, 'Murcia', 'MC', 45, 37.9835, -1.1307, NOW(), TRUE),
    (58, 3, 'Cantabria', 'CB', 45, 43.1820, -3.9876, NOW(), TRUE),
    (59, 3, 'La Rioja', 'RI', 45, 42.3449, -2.5100, NOW(), TRUE),
    (60, 3, 'Navarra', 'NA', 45, 42.6956, -1.6765, NOW(), TRUE),
    (61, 3, 'Asturias', 'AS', 45, 43.3664, -5.8495, NOW(), TRUE),
    (62, 3, 'Baleares', 'IB', 45, 39.6953, 3.0176, NOW(), TRUE),
    (63, 3, 'Ceuta', 'CE', 45, 35.8896, -5.3162, NOW(), TRUE),
    (64, 3, 'Melilla', 'ML', 45, 35.2932, -2.9380, NOW(), TRUE),
    -- Provincias de España
    (65, 4, 'Almería', 'AL', 46, 36.8340, -2.4637, NOW(), TRUE),
    (66, 4, 'Cádiz', 'CA', 46, 36.5271, -6.2886, NOW(), TRUE),
    (67, 4, 'Córdoba', 'CO', 46, 37.8882, -4.7794, NOW(), TRUE),
    (68, 4, 'Granada', 'GR', 46, 37.1773, -3.5986, NOW(), TRUE),
    (69, 4, 'Huelva', 'HU', 46, 37.2614, -6.9447, NOW(), TRUE),
    (70, 4, 'Jaén', 'JA', 46, 37.7694, -3.7886, NOW(), TRUE),
    (71, 4, 'Málaga', 'MA', 46, 36.7213, -4.4213, NOW(), TRUE),
    (72, 4, 'Sevilla', 'SE', 46, 37.3891, -5.9845, NOW(), TRUE),
    (73, 4, 'Huesca', 'HS', 54, 42.1363, -0.4089, NOW(), TRUE),
    (74, 4, 'Teruel', 'TR', 54, 39.8667, -1.7167, NOW(), TRUE),
    (75, 4, 'Zaragoza', 'ZG', 54, 41.6488, -0.8891, NOW(), TRUE),
    (76, 4, 'Asturias', 'AS', 61, 43.3619, -5.8494, NOW(), TRUE),
    (77, 4, 'Baleares', 'IB', 62, 39.5696, 2.6502, NOW(), TRUE),
    (78, 4, 'Álava', 'AL', 53, 42.8460, -2.6719, NOW(), TRUE),
    (79, 4, 'Guipúzcoa', 'GP', 53, 43.2572, -1.9780, NOW(), TRUE),
    (80, 4, 'Vizcaya', 'VI', 53, 43.2630, -2.9350, NOW(), TRUE),
    (81, 4, 'Las Palmas', 'LP', 55, 28.1235, -15.4363, NOW(), TRUE),
    (82, 4, 'Santa Cruz de Tenerife', 'ST', 55, 28.4682, -16.2546, NOW(), TRUE),
    (83, 4, 'Cantabria', 'CA', 58, 43.1828, -3.9878, NOW(), TRUE),
    (84, 4, 'Albacete', 'AB', 50, 38.9943, -1.8560, NOW(), TRUE),
    (85, 4, 'Ciudad Real', 'CR', 50, 38.9864, -3.9296, NOW(), TRUE),
    (86, 4, 'Cuenca', 'CU', 50, 40.0702, -2.1374, NOW(), TRUE),
    (87, 4, 'Guadalajara', 'GU', 50, 40.6333, -3.1667, NOW(), TRUE),
    (88, 4, 'Toledo', 'TL', 50, 39.8628, -4.0273, NOW(), TRUE),
    (89, 4, 'Ávila', 'AV', 49, 40.6566, -4.7058, NOW(), TRUE),
    (90, 4, 'Burgos', 'BU', 49, 42.3400, -3.7000, NOW(), TRUE),
    (91, 4, 'León', 'LE', 49, 42.5987, -5.5671, NOW(), TRUE),
    (92, 4, 'Palencia', 'PA', 49, 42.0095, -4.5280, NOW(), TRUE),
    (93, 4, 'Salamanca', 'SA', 49, 40.9701, -5.6635, NOW(), TRUE),
    (94, 4, 'Segovia', 'SG', 49, 40.9526, -4.1089, NOW(), TRUE),
    (95, 4, 'Soria', 'SO', 49, 41.7636, -2.4659, NOW(), TRUE),
    (96, 4, 'Valladolid', 'VA', 49, 41.6523, -4.7245, NOW(), TRUE),
    (97, 4, 'Zamora', 'ZA', 49, 41.5030, -5.7440, NOW(), TRUE),
    (98, 4, 'Barcelona', 'BC', 47, 41.3851, 2.1734, NOW(), TRUE),
    (99, 4, 'Girona', 'GI', 47, 41.9794, 2.8214, NOW(), TRUE),
    (100, 4, 'Lleida', 'LL', 47, 41.6176, 0.6200, NOW(), TRUE),
    (101, 4, 'Tarragona', 'TA', 47, 41.1189, 1.2445, NOW(), TRUE),
    (102, 4, 'Badajoz', 'BD', 56, 38.8794, -6.9706, NOW(), TRUE),
    (103, 4, 'Cáceres', 'CC', 56, 39.4767, -6.3722, NOW(), TRUE),
    (104, 4, 'A Coruña', 'AC', 52, 43.3623, -8.4115, NOW(), TRUE),
    (105, 4, 'Lugo', 'LU', 52, 43.0120, -7.5568, NOW(), TRUE),
    (106, 4, 'Ourense', 'OU', 52, 42.3370, -7.8636, NOW(), TRUE),
    (107, 4, 'Pontevedra', 'PO', 52, 42.4310, -8.6440, NOW(), TRUE),
    (108, 4, 'La Rioja', 'LR', 59, 42.4650, -2.4500, NOW(), TRUE),
    (109, 4, 'Madrid', 'MD', 48, 40.4168, -3.7038, NOW(), TRUE),
    (110, 4, 'Murcia', 'MU', 57, 37.9922, -1.1307, NOW(), TRUE),
    (111, 4, 'Navarra', 'NV', 60, 42.6956, -1.6765, NOW(), TRUE),
    (112, 4, 'Alicante', 'AL', 51, 38.3452, -0.4810, NOW(), TRUE),
    (113, 4, 'Castellón', 'CA', 51, 39.9864, -0.0514, NOW(), TRUE),
    (114, 4, 'Valencia', 'VA', 51, 39.4699, -0.3763, NOW(), TRUE),
    -- Ciudades de cada provincia
    (115, 6, 'Almería', NULL, 65, 36.8400, -2.4700, NOW(), TRUE),
    (116, 6, 'El Ejido', NULL, 65, 36.7800, -2.8000, NOW(), TRUE),
    (117, 6, 'Roquetas de Mar', NULL, 65, 36.7500, -2.4000, NOW(), TRUE),
    (118, 6, 'Cádiz', NULL, 66, 36.5271, -6.2886, NOW(), TRUE),
    (119, 6, 'Jerez de la Frontera', NULL, 66, 36.6850, -6.1370, NOW(), TRUE),
    (120, 6, 'Algeciras', NULL, 66, 36.1408, -5.4500, NOW(), TRUE),
    (121, 6, 'Córdoba', NULL, 67, 37.8882, -4.7794, NOW(), TRUE),
    (122, 6, 'Puente Genil', NULL, 67, 37.8500, -4.6500, NOW(), TRUE),
    (123, 6, 'Montilla', NULL, 67, 37.6800, -4.5600, NOW(), TRUE),
    (124, 6, 'Granada', NULL, 68, 37.1773, -3.5986, NOW(), TRUE),
    (125, 6, 'Motril', NULL, 68, 36.7500, -3.8500, NOW(), TRUE),
    (126, 6, 'Loja', NULL, 68, 37.1667, -3.2833, NOW(), TRUE),
    (127, 6, 'Huelva', NULL, 69, 37.2614, -6.9447, NOW(), TRUE),
    (128, 6, 'Lepe', NULL, 69, 37.2000, -6.9000, NOW(), TRUE),
    (129, 6, 'Moguer', NULL, 69, 37.3000, -6.9500, NOW(), TRUE),
    (130, 6, 'Jaén', NULL, 70, 37.7694, -3.7886, NOW(), TRUE),
    (131, 6, 'Linares', NULL, 70, 37.7833, -3.4500, NOW(), TRUE),
    (132, 6, 'Andújar', NULL, 70, 37.7600, -3.2600, NOW(), TRUE),
    (133, 6, 'Málaga', NULL, 71, 36.7213, -4.4213, NOW(), TRUE),
    (134, 6, 'Marbella', NULL, 71, 36.5100, -4.8820, NOW(), TRUE),
    (135, 6, 'Mijas', NULL, 71, 36.6000, -4.6333, NOW(), TRUE),
    (136, 6, 'Sevilla', NULL, 72, 37.3891, -5.9845, NOW(), TRUE),
    (137, 6, 'Dos Hermanas', NULL, 72, 37.2833, -5.9500, NOW(), TRUE),
    (138, 6, 'Alcalá de Guadaíra', NULL, 72, 37.3639, -5.8933, NOW(), TRUE),
    (139, 6, 'Huesca', NULL, 73, 42.1363, -0.4089, NOW(), TRUE),
    (140, 6, 'Jaca', NULL, 73, 42.5725, -0.5396, NOW(), TRUE),
    (141, 6, 'Monzón', NULL, 73, 41.4500, -0.3167, NOW(), TRUE),
    (142, 6, 'Teruel', NULL, 74, 39.8667, -1.7167, NOW(), TRUE),
    (143, 6, 'Alcañiz', NULL, 74, 41.0431, -0.5683, NOW(), TRUE),
    (144, 6, 'Mora de Rubielos', NULL, 74, 40.6439, -1.0833, NOW(), TRUE),
    (145, 6, 'Zaragoza', NULL, 75, 41.6488, -0.8891, NOW(), TRUE),
    (146, 6, 'Calatayud', NULL, 75, 41.4533, -1.0328, NOW(), TRUE),
    (147, 6, 'Ejea de los Caballeros', NULL, 75, 41.8031, -0.6961, NOW(), TRUE),
    (148, 6, 'Oviedo', NULL, 76, 43.3619, -5.8494, NOW(), TRUE),
    (149, 6, 'Gijón', NULL, 76, 43.5322, -5.6611, NOW(), TRUE),
    (150, 6, 'Avilés', NULL, 76, 43.5547, -5.9298, NOW(), TRUE),
    (151, 6, 'Palma de Mallorca', NULL, 77, 39.5696, 2.6502, NOW(), TRUE),
    (152, 6, 'Mahón', NULL, 77, 39.8880, 4.2640, NOW(), TRUE),
    (153, 6, 'Ibiza', NULL, 77, 38.9067, 1.4206, NOW(), TRUE),
    (154, 6, 'Vitoria-Gasteiz', NULL, 78, 42.8460, -2.6719, NOW(), TRUE),
    (155, 6, 'Llodio', NULL, 78, 43.0436, -2.9590, NOW(), TRUE),
    (156, 6, 'Amurrio', NULL, 78, 42.8540, -2.7780, NOW(), TRUE),
    (157, 6, 'San Sebastián', NULL, 79, 43.3183, -1.9812, NOW(), TRUE),
    (158, 6, 'Irun', NULL, 79, 43.3426, -1.7880, NOW(), TRUE),
    (159, 6, 'Tolosa', NULL, 79, 43.1670, -2.0320, NOW(), TRUE),
    (160, 6, 'Bilbao', NULL, 80, 43.2630, -2.9350, NOW(), TRUE),
    (161, 6, 'Barakaldo', NULL, 80, 43.3000, -2.9400, NOW(), TRUE),
    (162, 6, 'Getxo', NULL, 80, 43.3500, -3.0200, NOW(), TRUE),
    (163, 6, 'Las Palmas de Gran Canaria', NULL, 81, 28.1235, -15.4363, NOW(), TRUE),
    (164, 6, 'Telde', NULL, 81, 27.9800, -15.5500, NOW(), TRUE),
    (165, 6, 'Arucas', NULL, 81, 28.1330, -15.4370, NOW(), TRUE),
    (166, 6, 'Santa Cruz de Tenerife', NULL, 82, 28.4682, -16.2546, NOW(), TRUE),
    (167, 6, 'San Cristóbal de La Laguna', NULL, 82, 28.4845, -16.3190, NOW(), TRUE),
    (168, 6, 'Arona', NULL, 82, 28.1000, -16.7000, NOW(), TRUE),
    (169, 6, 'Santander', NULL, 83, 43.1828, -3.9878, NOW(), TRUE),
    (170, 6, 'Torrelavega', NULL, 83, 43.3490, -4.0200, NOW(), TRUE),
    (171, 6, 'Castro Urdiales', NULL, 83, 43.3360, -3.4900, NOW(), TRUE),
    (172, 6, 'Albacete', NULL, 84, 38.9943, -1.8560, NOW(), TRUE),
    (173, 6, 'Hellín', NULL, 84, 39.2167, -1.2667, NOW(), TRUE),
    (174, 6, 'Villarrobledo', NULL, 84, 39.1333, -1.6333, NOW(), TRUE),
    (175, 6, 'Ciudad Real', NULL, 85, 38.9864, -3.9296, NOW(), TRUE),
    (176, 6, 'Puertollano', NULL, 85, 38.7000, -4.1000, NOW(), TRUE),
    (177, 6, 'Alcázar de San Juan', NULL, 85, 39.0000, -3.8500, NOW(), TRUE),
    (178, 6, 'Cuenca', NULL, 86, 40.0702, -2.1374, NOW(), TRUE),
    (179, 6, 'Tarancón', NULL, 86, 40.0500, -2.2500, NOW(), TRUE),
    (180, 6, 'San Clemente', NULL, 86, 40.1000, -2.1000, NOW(), TRUE),
    (181, 6, 'Guadalajara', NULL, 87, 40.6333, -3.1667, NOW(), TRUE),
    (182, 6, 'Azuqueca de Henares', NULL, 87, 40.1667, -3.2500, NOW(), TRUE),
    (183, 6, 'Cabanillas del Campo', NULL, 87, 40.5000, -3.2000, NOW(), TRUE),
    (184, 6, 'Toledo', NULL, 88, 39.8628, -4.0273, NOW(), TRUE),
    (185, 6, 'Talavera de la Reina', NULL, 88, 39.9500, -4.4500, NOW(), TRUE),
    (186, 6, 'Illescas', NULL, 88, 39.8500, -4.2000, NOW(), TRUE),
    (187, 6, 'Ávila', NULL, 89, 40.6566, -4.7058, NOW(), TRUE),
    (188, 6, 'Arévalo', NULL, 89, 40.2500, -5.1700, NOW(), TRUE),
    (189, 6, 'Arenas de San Pedro', NULL, 89, 40.3000, -5.2000, NOW(), TRUE),
    (190, 6, 'Burgos', NULL, 90, 42.3400, -3.7000, NOW(), TRUE),
    (191, 6, 'Miranda de Ebro', NULL, 90, 42.8000, -3.4500, NOW(), TRUE),
    (192, 6, 'Aranda de Duero', NULL, 90, 41.6470, -3.6810, NOW(), TRUE),
    (193, 6, 'León', NULL, 91, 42.5987, -5.5671, NOW(), TRUE),
    (194, 6, 'Ponferrada', NULL, 91, 42.5464, -5.5636, NOW(), TRUE),
    (195, 6, 'Astorga', NULL, 91, 42.0000, -6.0667, NOW(), TRUE),
    (196, 6, 'Palencia', NULL, 92, 42.0095, -4.5280, NOW(), TRUE),
    (197, 6, 'Guardo', NULL, 92, 42.1500, -4.7000, NOW(), TRUE),
    (198, 6, 'Venta de Baños', NULL, 92, 42.0167, -4.4000, NOW(), TRUE),
    (199, 6, 'Salamanca', NULL, 93, 40.9701, -5.6635, NOW(), TRUE),
    (200, 6, 'Béjar', NULL, 93, 40.0667, -5.5000, NOW(), TRUE),
    (201, 6, 'Ciudad Rodrigo', NULL, 93, 40.5000, -6.0000, NOW(), TRUE),
    (202, 6, 'Segovia', NULL, 94, 40.9526, -4.1089, NOW(), TRUE),
    (203, 6, 'Cuéllar', NULL, 94, 41.2333, -4.3333, NOW(), TRUE),
    (204, 6, 'Sepúlveda', NULL, 94, 41.1500, -4.7000, NOW(), TRUE),
    (205, 6, 'Soria', NULL, 95, 41.7636, -2.4659, NOW(), TRUE),
    (206, 6, 'Almazán', NULL, 95, 41.6000, -2.4500, NOW(), TRUE),
    (207, 6, 'Calahorra de Boedo', NULL, 95, 41.7500, -2.5000, NOW(), TRUE),
    (208, 6, 'Valladolid', NULL, 96, 41.6523, -4.7245, NOW(), TRUE),
    (209, 6, 'Medina del Campo', NULL, 96, 41.0100, -4.9000, NOW(), TRUE),
    (210, 6, 'Laguna de Duero', NULL, 96, 41.3900, -4.7400, NOW(), TRUE),
    (211, 6, 'Zamora', NULL, 97, 41.5030, -5.7440, NOW(), TRUE),
    (212, 6, 'Benavente', NULL, 97, 41.2000, -5.6500, NOW(), TRUE),
    (213, 6, 'Toro', NULL, 97, 41.3100, -5.7000, NOW(), TRUE),
    (214, 6, 'Barcelona', NULL, 98, 41.3851, 2.1734, NOW(), TRUE),
    (215, 6, 'L\'Hospitalet de Llobregat', NULL, 98, 41.3662, 2.1167, NOW(), TRUE),
    (216, 6, 'Badalona', NULL, 98, 41.4500, 2.2500, NOW(), TRUE),
    (217, 6, 'Girona', NULL, 99, 41.9794, 2.8214, NOW(), TRUE),
    (218, 6, 'Figueres', NULL, 99, 42.2671, 2.9667, NOW(), TRUE),
    (219, 6, 'Blanes', NULL, 99, 41.6757, 2.8195, NOW(), TRUE),
    (220, 6, 'Lleida', NULL, 100, 41.6176, 0.6200, NOW(), TRUE),
    (221, 6, 'Balaguer', NULL, 100, 41.7000, 0.7500, NOW(), TRUE),
    (222, 6, 'Mollerussa', NULL, 100, 41.6667, 0.7500, NOW(), TRUE),
    (223, 6, 'Tarragona', NULL, 101, 41.1189, 1.2445, NOW(), TRUE),
    (224, 6, 'Reus', NULL, 101, 41.1565, 1.1069, NOW(), TRUE),
    (225, 6, 'Valls', NULL, 101, 41.1667, 1.2000, NOW(), TRUE),
    (226, 6, 'Badajoz', NULL, 102, 38.8794, -6.9706, NOW(), TRUE),
    (227, 6, 'Mérida', NULL, 102, 38.9170, -6.3370, NOW(), TRUE),
    (228, 6, 'Don Benito', NULL, 102, 38.9000, -5.2000, NOW(), TRUE),
    (229, 6, 'Cáceres', NULL, 103, 39.4767, -6.3722, NOW(), TRUE),
    (230, 6, 'Plasencia', NULL, 103, 40.0333, -6.3667, NOW(), TRUE),
    (231, 6, 'Navalmoral de la Mata', NULL, 103, 39.7000, -6.8000, NOW(), TRUE),
    (232, 6, 'A Coruña', NULL, 104, 43.3623, -8.4115, NOW(), TRUE),
    (233, 6, 'Santiago de Compostela', NULL, 104, 42.8800, -8.5457, NOW(), TRUE),
    (234, 6, 'Ferrol', NULL, 104, 43.4833, -8.2500, NOW(), TRUE),
    (235, 6, 'Lugo', NULL, 105, 43.0120, -7.5568, NOW(), TRUE),
    (236, 6, 'Monforte de Lemos', NULL, 105, 42.4667, -7.6000, NOW(), TRUE),
    (237, 6, 'Vilalba', NULL, 105, 42.6500, -7.7000, NOW(), TRUE),
    (238, 6, 'Ourense', NULL, 106, 42.3370, -7.8636, NOW(), TRUE),
    (239, 6, 'Verín', NULL, 106, 42.1730, -7.7330, NOW(), TRUE),
    (240, 6, 'O Barco de Valdeorras', NULL, 106, 42.4500, -7.6000, NOW(), TRUE),
    (241, 6, 'Pontevedra', NULL, 107, 42.4310, -8.6440, NOW(), TRUE),
    (242, 6, 'Vigo', NULL, 107, 42.2406, -8.7207, NOW(), TRUE),
    (243, 6, 'Vilagarcía de Arousa', NULL, 107, 42.6833, -8.5833, NOW(), TRUE),
    (244, 6, 'Logroño', NULL, 108, 42.4667, -2.4500, NOW(), TRUE),
    (245, 6, 'Calahorra', NULL, 108, 42.4667, -2.4667, NOW(), TRUE),
    (246, 6, 'Haro', NULL, 108, 42.5333, -2.6333, NOW(), TRUE),
    (247, 6, 'Madrid', NULL, 109, 40.4168, -3.7038, NOW(), TRUE),
    (248, 6, 'Móstoles', NULL, 109, 40.3225, -3.8650, NOW(), TRUE),
    (249, 6, 'Alcorcón', NULL, 109, 40.3468, -3.8260, NOW(), TRUE),
    (250, 6, 'Murcia', NULL, 110, 37.9922, -1.1307, NOW(), TRUE),
    (251, 6, 'Cartagena', NULL, 110, 37.6250, -0.9860, NOW(), TRUE),
    (252, 6, 'Lorca', NULL, 110, 37.6833, -1.7000, NOW(), TRUE),
    (253, 6, 'Pamplona', NULL, 111, 42.8163, -1.6458, NOW(), TRUE),
    (254, 6, 'Tudela', NULL, 111, 42.0667, -1.6500, NOW(), TRUE),
    (255, 6, 'Estella', NULL, 111, 42.3167, -1.9667, NOW(), TRUE),
    (256, 6, 'Alicante', NULL, 112, 38.3452, -0.4810, NOW(), TRUE),
    (257, 6, 'Elche', NULL, 112, 38.2699, -0.7126, NOW(), TRUE),
    (258, 6, 'Benidorm', NULL, 112, 38.5411, -0.1220, NOW(), TRUE),
    (259, 6, 'Castellón de la Plana', NULL, 113, 39.9864, -0.0514, NOW(), TRUE),
    (260, 6, 'Vinaròs', NULL, 113, 40.5000, 0.1167, NOW(), TRUE),
    (261, 6, 'Onda', NULL, 113, 39.8833, -0.1500, NOW(), TRUE),
    (262, 6, 'Valencia', NULL, 114, 39.4699, -0.3763, NOW(), TRUE),
    (263, 6, 'Gandía', NULL, 114, 38.9667, -0.1833, NOW(), TRUE),
    (264, 6, 'Torrent', NULL, 114, 39.4667, -0.4667, NOW(), TRUE),
    -- Barrios de Zamora
    (265, 7, 'Barrio de Pantoja', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    (266, 7, 'Barrio del Sepulcro', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    (267, 7, 'Barrio de Alviar', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    (268, 7, 'Barriada de Asturias', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    (269, 7, 'Barrio de Los Bloques', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    (270, 7, 'Barrio de Cabañales', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    (271, 7, 'Barrio de La Candelaria', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    (272, 7, 'Barrio de Carrascal', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    (273, 7, 'Barrios Bajos', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    (274, 7, 'Barrio de la Lana', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    (275, 7, 'Barrio de Las Llamas', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    (276, 7, 'Barrio de Olivares', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    (277, 7, 'Barrio de Peña Trevinca', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    (278, 7, 'Barrio de Pinilla', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    (279, 7, 'Barrio de Rabiche', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    (280, 7, 'Barrio de San Frontis', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    (281, 7, 'Barrio de San Isidro, Espíritu Santo y Obelisco', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    (282, 7, 'Barrio de San José Obrero', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    (283, 7, 'Barrio de San Lázaro', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    (284, 7, 'Barrio de El Sepulcro', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    (285, 7, 'Barrio de Villagodio', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    (286, 7, 'Barrio de Las Viñas', NULL, 211, 41.5030, -5.7440, NOW(), TRUE),
    -- Barrios de Salamanca
    (287, 7, 'Centro', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
    (288, 7, 'Universidad', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
    (289, 7, 'San Vicente', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
    (290, 7, 'Sancti-Spiritus', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
    (291, 7, 'San Juan', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
    (292, 7, 'Tenerías', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
    (293, 7, 'Úrsulas', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
    (294, 7, 'San Cristóbal', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
    (295, 7, 'San Esteban', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
    (296, 7, 'Alamedilla', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
    (297, 7, 'Delicias', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
    (298, 7, 'San Isidro', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
    (299, 7, 'Prosperidad', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
    (300, 7, 'Rollo-Las Pajas', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
    (301, 7, 'Fontana', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
    (302, 7, 'Santo Tomás', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
    (303, 7, 'Puente Ladrillo', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
    (304, 7, 'Labradores', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
    (305, 7, 'Salesas', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
    (306, 7, 'Garrido Norte', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
    (307, 7, 'Garrido Sur', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
    (308, 7, 'Chinchibarra', NULL, 199, 40.9701, -5.6635, NOW(), TRUE),
...
INSERT INTO `alertas` (`titulo`, `descripcion`, `id_categoria`, `estado`, `fecha_creacion`, `id_ubicacion`, `id_imagen`) VALUES
    ...
    ('Festival de cine', 'Un festival de cine al aire libre en el casco antiguo ha atraído a numerosos visitantes. El evento incluye proyecciones de películas independientes y actividades culturales.', 7, 'pendiente', '2025-02-25 15:11:45', 265, NULL),
    ('Corte de tráfico por evento', 'Un evento cultural en el centro de la ciudad ha provocado cortes de tráfico en varias calles. Se recomienda utilizar rutas alternativas para evitar retrasos.', 1, 'pendiente', '2025-02-25 15:11:45', 265, NULL),
    ...
    ('Inundaciones en India', 'Las lluvias monzónicas provocan inundaciones catastróficas en Bengala Occidental, con miles de desplazados.', 2, 'pendiente', '2025-03-01 13:50:00', 27, NULL),
    ...
    ('Accidente de tráfico en Toledo', 'Colisión frontal en la CM-40 con dos víctimas graves. Retenciones de 5 km.', 1, 'pendiente', '2025-03-02 16:30:00', 88, NULL),
    ('Robos en Ávila', 'Ola de robos en viviendas del casco histórico. Policía investiga banda organizada.', 3, 'pendiente', '2025-03-02 17:40:00', 89, NULL),
    ...
    ('Corte eléctrico en Sevilla', 'Subestación afectada por sobrecarga deja sin luz a 20,000 hogares.', 4, 'pendiente', '2025-03-06 08:15:00', 136, NULL);
